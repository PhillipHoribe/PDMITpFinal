...
namespace TpFinal
{
    public partial class MainPage : ContentPage
    {
        ...
        private async void BtnAdd_Clicked(object sender, EventArgs e)
        {
            ...
            {
                await DisplayAlert("Falha", "Entre com os dados corretamente", "OK");
            }
        }
        ...
        public async void BtnRead_Clicked(object sender, EventArgs e)
        {
            ...
            {
                await DisplayAlert("Falha", "Entre com o ID", "OK");
            }
        }
        ...
        {
            await DisplayAlert("Done","Feito por Phillip Horibe", "OK");
        }
    }
}
